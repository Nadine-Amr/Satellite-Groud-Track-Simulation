function [] = GT_from_R0V0_UniversalKepler(R0, V0, plot_time)

% This code plots the satellite's ground track throughout a user-defined
% period of time using the universal Kepler equations. Its inputs are the satellite's initial state vector as well 
...
for i = 1:length(t)-1
    t(i+1) = t(i)+dt;
    [r{i+1},v{i+1}] = rv_from_r0v0(r{1},v{1}, t(i+1));
